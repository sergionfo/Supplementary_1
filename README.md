...
5. SeisBench models
Th study evaluates pretrained phase-picking models available through SeisBench.  
...
The STA/LTA configuration used in the study was:
STA window: 1 s
LTA window: 10 s
trigger threshold: 
detrigger threshold:, if applicable
filtering: 1 - 20 Hz  
sampling rate: 100 Hz  

The parameters were [tuned using the evaluation dataset / adopted from the operational configuration / specify actual procedure].
